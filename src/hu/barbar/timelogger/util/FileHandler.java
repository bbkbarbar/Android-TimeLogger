...
import hu.barbar.timelogger.MainActivity;
...
public class FileHandler {
	...
	public static final int RESULT_ERROR_WRITE_NULL_CONTENT = -1;
	public static final int RESULT_ERROR_WRITE_EMPTY = -2;
	...
	public FileHandler(MainActivity parent){
	...
	private String generateFilepath(boolean needToAttachTimeStamp) {
